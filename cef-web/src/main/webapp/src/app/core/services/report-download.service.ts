...
export class ReportDownloadService {
    ...
    downloadFile(data?: any, filename = 'data', dataCsv?: string) {
        ...
        const csvData = dataCsv ? dataCsv : this.ConvertToCSV(data, ['facilitySiteId', 'reportYear', 'emissionsUnitId', 'emissionUnitDescription',
            'processId', 'processDescription', 'reportingPeriodType', 'throughputMaterial', 'throughputValue', 'throughputUom','fuelUseMaterial', 
            'fuelUseValue', 'fuelUseUom', 'heatContentValue', 'heatContentUom', 'pollutantName',
