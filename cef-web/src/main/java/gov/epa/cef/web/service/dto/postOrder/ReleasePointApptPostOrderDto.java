 ...
 * but the ReleasePointPostOrderDto will not contain a list of these ReleasePointApptPostOrderDto objects.  This helps avoid circular references when traversing the hierarchy post order.
 * @author kbrundag
 *
 */
