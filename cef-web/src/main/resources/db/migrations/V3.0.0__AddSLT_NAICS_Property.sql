...
CREATE OR REPLACE FUNCTION create_slt_faciliyt_naics() RETURNS void AS $$
DECLARE
	psc RECORD;
BEGIN
 ...
 DO $$ 
 BEGIN
 PERFORM "create_slt_faciliyt_naics"();
 DROP FUNCTION IF EXISTS create_slt_faciliyt_naics();
 END;$$
