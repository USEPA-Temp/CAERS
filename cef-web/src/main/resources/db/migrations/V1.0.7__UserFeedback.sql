...
(
  ...
  beneficial_functionality_description				VARCHAR(500),
  difficult_application_functionality_description 	VARCHAR(500),
  additional_features_or_enhancements_description 	VARCHAR(500),
